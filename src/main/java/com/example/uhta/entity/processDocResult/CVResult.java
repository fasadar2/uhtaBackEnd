...
public class CVResult {
    ...
    private Double limitGiveup;

    @Column(name = "LimitViolation")
    private Double limitViolation;
    ...
    @Column(name = "UnbiasedPrediction")
    private Integer unbiasedPrediction;

    @Column(name = "ModelMismatch")
